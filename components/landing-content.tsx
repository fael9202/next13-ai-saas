...
const testimonials = [
  ...
  },
  {
    ...
    avatar: "M",
    title: "CEO",
    description: "Este aplicativo mudou minha vida, não consigo imaginar trabalhar sem ele!",
  },
  {
    name: "Mary",
    avatar: "M",
...
export const LandingContent = () => {
  return (
    <div className="px-10 pb-20">
      <h2 className="text-center text-4xl text-white font-extrabold mb-10">Provas Sociais</h2>
